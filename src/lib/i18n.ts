...
const resources = {
  ar: {
    translation: {
      ...
      overview: "نظرة عامة",
      drivers_list: "السائقين",
      shippers_list: "أصحاب الحمولات",
      orders_list: "الطلبات",
